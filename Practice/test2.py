...
# pipe = pipeline("text-classification", model="pysentimiento/roberta-targeted-sentiment-analysis")

# 加载 RoBERTa 情感分析模型
classifier = pipeline("text-classification", model="pysentimiento/roberta-targeted-sentiment-analysis")
